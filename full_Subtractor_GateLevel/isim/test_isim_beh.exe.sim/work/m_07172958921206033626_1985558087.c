...
#endif
static const char *ng0 = "A = %d | B = %d | Borrow_in = %d | Diff  = %d | Borrow_out = %d";
static const char *ng1 = "/home/sandeep/git_workspace/Verilog-VHDL/full_Subtractor_GateLevel/test.v";
static int ng2[] = {1, 0};

...
#endif
static const char *ng0 = "A = %d | B = %d | Difference = %d | Borrow = %d";
static const char *ng1 = "/home/sandeep/git_workspace/Verilog-VHDL/halfSubtractor/test.v";
static int ng2[] = {1, 0};

void Monitor_45_2(char *);
void Monitor_45_2(char *);


static void Monitor_45_2_Func(char *t0)
{
    char *t1;
    char *t2;
    char *t3;
...
LAB0:    t1 = (t0 + 3232);
    t2 = (t0 + 3744);
    xsi_vlogfile_monitor((void *)Monitor_45_2_Func, t1, t2);
...
{
	static char *pe[] = {(void *)Always_44_0,(void *)Initial_45_1,(void *)Initial_46_3,(void *)Monitor_45_2};
